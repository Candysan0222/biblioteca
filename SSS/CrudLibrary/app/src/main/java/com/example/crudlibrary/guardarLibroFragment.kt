...
class guardarLibroFragment : Fragment() {
    ...
    private  var id_libro:String="3faa0851-af96-4752-8790-77c7283c900a"
        ...
        if (id_libro !=""){
            var request=JsonObjectRequest(
                ...
                {response->
                    ...
                    txtDisponible.setText(libro.numero_ejemplares_disponibles)
                    txtOcupado.setText(libro.numero_ejemplares_ocupados)
